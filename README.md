...
```text
~/.codex/skills/weekly-work-skill
```
...
scripts/
tests/
assets/weekly-report-template.docx
references/external-ai-prompt.md
agents/openai.yaml
```
...
也可以运行 Codex skill 校验：

```bash
python ~/.codex/skills/.system/skill-creator/scripts/quick_validate.py ~/.codex/skills/weekly-work-skill
```

## 仓库

https://github.com/xjchen1/weekly-work-skill
```
